  ...
  render() {
    ...
    return (
      <div className={styles.loginDiv}>
        <Button size="large" onClick={this.props.toggleLoginModal} className={styles.loginButton}>
          Login
        </Button>
        <Dialog
        ...
        >
          ...
          <DialogActions className={styles.modalAction}>
            <Button onClick={this.props.toggleLoginModal} className={styles.closeButton}>
              <SvgIcon>
